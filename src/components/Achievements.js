...
function Achievements(props){
    ...
    const hardAchievements = [
        ...
        {"mix": "treasure",
        "description": "Find a beachy treasure and gift it to a friend"},
        {"name": "vHard",
        ...
        {"name": "boat",
        "description": "Go boating with at least two other people"},
        {"name": "yumejiHard",
        ...
        {"name": "mix",
        "description": "Mix a drink for someone else and have them drink it"},
        {"name": "show",
        ...
        {"name": "hotSprings",
        "description": "Take a (fully clothed) dip in the hot springs"},
        {"name": "hatmanHard",
